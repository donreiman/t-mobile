...
describe('FetchPriceQueryForDateRangeEffect', () => {
  let stockQuotes: PriceQueryResponse[];
  let filteredStockQuotes: PriceQueryResponse[];
  
  let iexService: IexService;
  // let priceQueryEffects: PriceQueryEffects;
  ...
  beforeEach(() => { 
    ...
    // priceQueryEffects = TestBed.get(PriceQueryEffects);
  });
  ...
  it('should return a filtered array of stock quotes', () => {
    ...
    const completion = new PriceQueryFetched(filteredStockQuotes);

    // TODO
    // verify that loadPriceForDateRangeQuery effect fires when FetchPriceQueryForDateRange action is dispatched with payload (stockQuotes)
    // verify that PriceQueryFetched action is dispatched with payload (filteredStockQuotes)
  });
});